...
const Calendar = () => {
    ...
    const onDragStop = async (args) => {
        ...
        try {
          ...
          await updateDoc(jobRef, {
            startDate: StartTime.toISOString(), // Save as ISO string
    ...
    const onResizeStop = async (args) => {
        ...
        try {
          ...
          toast.success(`Job ${Id} updated successfully.`); // Show success notification
          console.log(`Job ${Id} updated in Firebase.`);
        } catch (error) {
          console.error("Error updating job in Firebase:", error);
          toast.error("Failed to update job. Please try again."); // Show error notification
        }
      };
